    ...
    export default {
        ...
        methods:{
            getTInfo(){
                ...
                list.travelReiForm.ename = sessionStorage.getItem('ename')
                this.travelReiForm.state = this.$route.query.tInfo.state
            ...
            selectTicket() {
                if(this.isClear){
                    ...
                    this.$message.warning("请先清空当前信息，再选择新的车票信息")
                }
            ...
            countSubsidy(){
                let selections = this.ticketInfo;
                let arr = [];
                let totalSubsidy = 0;
                let totalMoney = 0;
            ...
            deleteAll(){
                ...
                this.travelReiForm.tno = this.$route.query.tInfo.tno
            },
            save(){
                //表单校验
                this.$refs["travelReiForm"].validate(valid => {
                    if (valid) {
                        ...
                        this.$http.post('/updatetravelrei',this.travelReiForm).then(res => {
                            if (res.data == "success") {
            ...
            submit(){
                if(this.isSave){
                    this.$http.get('/submittravel',{
                        params:{
                            tno: this.travelReiForm.tno,
                            state: this.travelReiForm.state
                        }}).then(res => {
                        if (res.data == "success") {
