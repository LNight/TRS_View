<template>
    <div>
        ...
        <el-breadcrumb separator="/" style="padding-left: 10px;padding-bottom: 10px;font-size: 12px">
            <el-breadcrumb-item :to="{ path: '/managerindex'}">首页</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/managerapproval' }">审批</el-breadcrumb-item>
            ...
            pass(){
                this.$http.get('/passapproval',{
                    ...
                    if (res.data == "success") {
                        ...
                        this.$router.push('/managerapproval')
                    } else  {
