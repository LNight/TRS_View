<template>
    <div>
        ...
        <el-breadcrumb separator="/" style="padding-left: 10px;padding-bottom: 10px;font-size: 12px">
            <el-breadcrumb-item :to="{ path: '/cashierindex'}">首页</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/cashierapproval' }">审批</el-breadcrumb-item>
            ...
            pass(){
                this.$http.get('/passapproval',{
                    ...
                    if (res.data == "success") {
                        ...
                        this.$router.push('/cashierapproval')
                    } else  {
